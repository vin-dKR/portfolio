...
const ProjectModal = ({ project, onClose }: ProjectModalProps) => {
    ...
    return (
        <div 
            className="fixed inset-0 z-50 flex items-center justify-center bg-white dark:bg-black dark:bg-opacity-70 bg-opacity-70" onClick={onClose}
            style={{ margin: 0, padding: 0, top: 0 }}
        >
            <div 
                className="bg-white dark:bg-slate-950 border rounded-lg shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto"
                onClick={(e) => e.stopPropagation()}
            >
                {/* Mac-style header */}
                <div className="px-4 py-3 bg-gray-100 dark:bg-zinc-950 border rounded-t-lg flex items-center border-b border-gray-200 dark:border-gray-600">
