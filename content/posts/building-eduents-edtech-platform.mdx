...
> 🎥 VIDEO: 15-second clip - upload a PDF, see "page 1 detecting...", "page 1 cropped", etc, then the final list of questions and images. Real working pipeline.

> 📸 IMAGE: Three side-by-side panels - "raw PDF page" -> "image with green boxes drawn around diagrams" -> "cropped image alone". Shows the pipeline visually.
...
> 📸 IMAGE: A clean photo of you (headshot or working at a laptop) at the very bottom, plus a short call-to-action - email and GitHub link. Closes the post on a personal note.
